...
%Some examples of relevance algorithms that may be applied here are spell correction, standardization of concepts (for example, unifying “software engineer” and “computer programmer”), and graph analysis.
...
\lucenequery{+(?TITLE:marketing ?SKILL:marketing ?DESCRIPTION:marketing)}
...
$X$ = \lucenequery{(?TITLE:marketing, ?SKILL:marketing, ?DESCRIPTION:marketing)}
...
More formally given $k$ conjuntive query clauses $X = (x_1, x_2 \ldots x_k)$ and
...
\item Ranking models
\item Operational flags (retrieval flags) \TODO{what is this?}
\end{itemize}
